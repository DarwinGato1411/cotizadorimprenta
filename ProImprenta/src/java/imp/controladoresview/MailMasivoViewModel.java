 ...
 * @author gato
 */
public class MailMasivoViewModel {
...
//                    fileInputStream.close();
    ...
    public void subirArchivoFTP(String nombre, String ruta) {
        try {
            ...
            ftpClient.connect(InetAddress.getByName("bestsystemec.com"));
            ftpClient.login("imagenbest@bestsystemec.com", "imagenbest123");
...
//            rutaFTP = "https://dereckylaydy.com/dereckylaydy.com/imagenec/" + nombreArchivoMail;
            rutaFTP = "http://www.bestsystemec.com/bestsystemec.com/imagenbest/" + nombreArchivoMail;
        } catch (Exception e) {
