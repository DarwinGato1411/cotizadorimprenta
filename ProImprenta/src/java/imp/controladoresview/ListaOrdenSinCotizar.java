 ...
 * @author gato
 */
public class ListaOrdenSinCotizar {
...
//                servicioCotizacion.modificar(valor);
    ...
    private void findAllOrdenSinCotizar() {
        listaOrdenSinCotizacion = servicioOrdenSinCotizar.listaOrdenFindAll();
    }
...
//            
            final HashMap<String, OrdenSinCotizacion> map = new HashMap<String, OrdenSinCotizacion>();
            valor.setTipoOperacion("MODIFICAR");
            map.put("valor", valor);
            org.zkoss.zul.Window window = (org.zkoss.zul.Window) Executions.createComponents(
    ...
    private void buscarForCliente() {
        listaOrdenSinCotizacion = servicioOrdenSinCotizar.listaOrdenFindAllPendienteCliente(busCliente);
    }
    
    private void buscarForNumero() {
        listaOrdenSinCotizacion = servicioOrdenSinCotizar.listaOrdenFindAllNumero(busNumero);
    }
    ...
    private void buscarForFecha() {
        listaOrdenSinCotizacion = servicioOrdenSinCotizar.listaOrdenFindFechasGenerada(fechaInicio, fechaFin);
    }
    
    private void buscarForNombreFecha() {
        listaOrdenSinCotizacion = servicioOrdenSinCotizar.findAllNombreFechasFacturadaGenerada(fechaInicio, fechaFin, busCliente);
    }
    ...
    public void buscarPorNumeroFactura() throws JRException, IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        try {
            findBySinNumeroFacturaGenerada();
        } catch (Exception e) {
            Messagebox.show("Error " + e.toString(), "Atención", Messagebox.OK, Messagebox.INFORMATION);
        }
    }
    
    private void findBySinNumeroFacturaGenerada() {
        listaOrdenSinCotizacion = servicioOrdenSinCotizar.findBySinNumeroFacturaGenerada(numeroFactura);
    }
    ...
    private void findAllGeneradanombreComercial() {
        listaOrdenSinCotizacion = servicioOrdenSinCotizar.findAllGeneradanombreComercial(nombreComercial);
    }
