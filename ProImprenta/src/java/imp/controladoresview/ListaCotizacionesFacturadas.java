 ...
 * @author gato
 */
public class ListaCotizacionesFacturadas {
...
//    ServicioSecuencia servicioSecuencia = new ServicioSecuencia();
    ...
    public ListaCotizacionesFacturadas() {
...
//            window.detach();
    ...
    public void unificarCotizacion() throws JRException, IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        try {
            if (registrosSeleccionados.size() > 0) {
                ...
                Messagebox.show("Cotizaciones unificadas correctamente", "Atención", Messagebox.OK, Messagebox.INFORMATION);
            } else {
    ...
    public void buscarListaPorFechas() throws JRException, IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        try {
            consultarListaCotizacionFechas();
        } catch (Exception e) {
            Messagebox.show("Error " + e.toString(), "Atención", Messagebox.OK, Messagebox.INFORMATION);
        }
    }
    ...
    private void consultarListaCotizacion() {
        listaCotizacionesData = servicioCotizacion.listaCotizacionLikeNumeroFacturadas(busNumero);
        getDescripcionGeneral();
    }

    private void consultarListaCotizacionFechas() {
        listaCotizacionesData = servicioCotizacion.listaCotizacionFechas(fechaInicio, fechaFin);
        getDescripcionGeneral();
    }

    private void consultarListaCotizacionPorCliente() {
        listaCotizacionesData = servicioCotizacion.findAllLikeClienteFacturadas(busCliente);
        getDescripcionGeneral();
    }
